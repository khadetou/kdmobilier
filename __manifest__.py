{
    ...
    "data": [
        ...
        # "views/snippets/s_mega_menu_hotcodes_1.xml",
        # "views/snippets/snippets.xml",
        # "views/snippets/s_banners.xml",
        # "views/snippets/s_top_review.xml",
        # "views/snippets/s_text_image.xml",
        # "views/snippets/s_image_text.xml",
        # "views/snippets/s_services.xml",
        # "views/snippets/s_work_process.xml",
        # "views/snippets/s_customer_review.xml",
        # "views/snippets/s_customers.xml",
        # "views/snippets/s_intergration.xml",
        # "views/snippets/s_blog.xml",
        # "views/snippets/s_cta.xml",
        # "views/snippets/s_promo.xml",
        # "views/snippets/s_features.xml",
        # "views/snippets/s_story.xml",
        # "views/snippets/s_team.xml",
        # "views/snippets/s_location.xml",
        # "views/snippets/s_blog_blockquote.xml",
        # "views/snippets/s_contact_promo.xml",
